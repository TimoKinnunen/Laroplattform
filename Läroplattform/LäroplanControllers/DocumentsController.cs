...
namespace Läroplattform.LäroplanControllers
{
    public class DocumentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DocumentTypeId,Name,Description,StartDate,FeedbackFromTeacherToStudent")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DocumentTypeId,Name,Description,StartDate,FeedbackFromTeacherToStudent")] Document document)
        {
            if (ModelState.IsValid)
            {
