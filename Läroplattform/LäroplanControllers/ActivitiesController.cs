...
namespace Läroplattform.LäroplanControllers
{
    public class ActivitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ActivityTypeId,ModuleId,Name,Description,StartDate,EndDate")] Activity activity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ActivityTypeId,ModuleId,Name,Description,StartDate,EndDate")] Activity activity)
        {
            if (ModelState.IsValid)
            {
